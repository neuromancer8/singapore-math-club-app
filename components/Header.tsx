        ...
        <nav className="flex flex-wrap gap-2 text-sm font-extrabold text-slate-800">
          ...
          {session ? (
            ...
            >
              ...
              <span className="rounded-full px-3 py-2 font-extrabold text-slate-800">Profilo</span>
            </button>
          ) : (
            <button
              type="button"
          ...
          <div className="max-h-[92vh] w-full max-w-5xl overflow-y-auto rounded-[36px] border border-white/60 bg-white/94 p-5 shadow-[0_30px_90px_rgba(15,23,42,0.18)] md:p-7">
            <div className="mb-5 flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <h2 className="section-title mt-4 text-4xl font-black leading-tight text-slate-900">Profilo di {session.firstName}</h2>
                <p className="mt-3 mb-0 text-base font-bold leading-7 text-slate-600">
                  Da qui puoi scegliere l&apos;avatar sicuro del bambino e uscire dall&apos;account demo.
                </p>
              </div>
              <button
                type="button"
            ...
            <AvatarPicker session={session} onChange={setSession} />
