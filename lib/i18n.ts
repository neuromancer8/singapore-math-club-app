...
export const uiText = {
  it: {
    ...
    invalidCredentials: "Credenziali non valide. Controlla username e password oppure crea un nuovo account genitore.",
    username: "Username",
    password: "Password",
    ...
    usernameTaken: "Questo username e gia in uso. Proviamo con un altro.",
  ...
  en: {
    ...
    invalidCredentials: "Invalid credentials. Check username and password or create a new parent account.",
    username: "Username",
    password: "Password",
    ...
    usernameTaken: "This username is already taken. Let's try another one.",
