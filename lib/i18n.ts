...
export const uiText = {
  it: {
    ...
    registerDescription:
      "Il genitore si registra una sola volta e crea il primo profilo bambino. In seguito può aggiungerne altri dall'area profilo.",
    registerNow: "Crea account e primo profilo",
    emailTaken: "Questa email è già in uso. Proviamo con un'altra.",
    ...
    childProfileInvalid: "Inserisci nome, cognome, classe e avatar per salvare il profilo bambino.",
    verificationRequired: "Ti abbiamo inviato una verifica email. Conferma l'indirizzo del genitore prima di accedere.",
    verificationPending: "Questa email non è ancora verificata.",
    ...
    previewFallbackNotice:
      "Su questa versione l'invio email automatico non è ancora attivo. Usa il pulsante qui sotto per aprire subito il link di verifica o recupero.",
  ...
  en: {
    ...
    childProfileInvalid: "Enter first name, last name, grade and avatar to save the child profile.",
