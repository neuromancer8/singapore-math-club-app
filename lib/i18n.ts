...
export const uiText = {
  it: {
    ...
    loginTitle: "Accedi",
    loginDescription:
      "La pagina resta visibile a tutti. L'accesso apre la dashboard personale e sincronizza profilo e progressi del bambino.",
    invalidCredentials: "Credenziali non valide. Usa uno degli account presenti qui sotto oppure crea in seguito utenti veri nel database.",
    username: "Username",
    password: "Password",
    loginWithAdmin: "Accedi all'area personale",
    demoCredentials: "Account disponibili",
    profile: "Profilo",
    logout: "Esci",
    profileArea: "Area profilo",
    profileTitle: "Profilo di",
    profileDescription: "Da qui puoi scegliere l'avatar sicuro del bambino e uscire dall'account personale.",
    logoutFrom: "Esci da",
  ...
  en: {
    ...
    loginTitle: "Log in",
    loginDescription:
      "The page stays visible to everyone. Login opens the personal dashboard and syncs the child's profile and progress.",
    invalidCredentials: "Invalid credentials. Use one of the accounts listed below, or later connect real users in the database.",
    username: "Username",
    password: "Password",
    loginWithAdmin: "Log in to the personal area",
    demoCredentials: "Available accounts",
    profile: "Profile",
    logout: "Log out",
    profileArea: "Profile area",
    profileTitle: "Profile of",
    profileDescription: "Choose the child's safe avatar here and log out of the personal account.",
    logoutFrom: "Log out",
